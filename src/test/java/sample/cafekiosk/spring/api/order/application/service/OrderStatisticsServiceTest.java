...
import sample.cafekiosk.spring.api.mail.application.MailSender;
import sample.cafekiosk.spring.api.order.application.dto.request.OrderCreateServiceRequest;
...
import sample.cafekiosk.spring.api.stock.repository.StockRepository;
...
import static sample.cafekiosk.spring.api.product.utility.ProductUtils.createProduct;
